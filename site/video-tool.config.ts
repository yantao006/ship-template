...
const play = '/video-tool/minimax-logo.png';
const wave = '/video-tool/seedance-logo.svg';
const bars = '/video-tool/wan-logo.svg';
const spark = '/video-tool/grok-logo.svg';
const gem = '/video-tool/kling-logo.svg';
const bloom = '/video-tool/seedream-logo.svg';
const ring = '/video-tool/openai-logo.svg';
const sun = '/video-tool/banana-logo.svg';
...
const config: VideoToolStructure = {
  ...
  vendors: [
    { id: 'minimax', icon: play }, { id: 'seedance', icon: wave }, { id: 'wan', icon: bars }, { id: 'grok', icon: spark }, { id: 'kling', icon: gem },
    { id: 'seedream', icon: bloom }, { id: 'openai', icon: ring }, { id: 'nano', icon: sun },
  ],
  models: [
    { id: 'minimax-h3-max', vendorId: 'minimax', icon: play, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: wide, resolution: hd }, stops: { duration: [6, 10] }, tags: [{ id: 'max', tone: 'crown', icon: crown }], count: 68, costByDuration: { 6: 68, 10: 148 } },
    { id: 'minimax-h3', vendorId: 'minimax', icon: play, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: clip, resolution: hd }, stops: { duration: [6, 10] }, tags: [], count: 42, costByDuration: { 6: 42, 10: 104 } },
    { id: 'minimax-h3-lite', vendorId: 'minimax', icon: play, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: ['16-9'], resolution: ['720p'] }, stops: { duration: [6] }, tags: [{ id: 'free', tone: 'success' }], count: 18, costByDuration: { 6: 18 } },
    { id: 'seedance-2-5', vendorId: 'seedance', icon: wave, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: wide, resolution: hd }, stops: { duration: [5, 10] }, tags: [], count: 55, costByDuration: { 5: 55, 10: 110 } },
    { id: 'seedance-2-0', vendorId: 'seedance', icon: wave, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: clip, resolution: hd }, stops: { duration: [5, 10] }, tags: [], count: 40, costByDuration: { 5: 40, 10: 80 } },
    { id: 'seedance-2-0-fast', vendorId: 'seedance', icon: wave, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: ['16-9'], resolution: ['720p'] }, stops: { duration: [5] }, tags: [{ id: 'fast', tone: 'info' }], count: 16, costByDuration: { 5: 16 } },
    { id: 'seedance-2-0-mini', vendorId: 'seedance', icon: wave, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: ['16-9'], resolution: ['720p'] }, stops: { duration: [5] }, tags: [], count: 12, costByDuration: { 5: 12 } },
    { id: 'seedance-1-5-pro', vendorId: 'seedance', icon: wave, workflowIds: videoFlows, fieldIds: [...clipFields, 'seed'], options: { ratio: clip, resolution: hd }, stops: { duration: [4, 8, 12] }, tags: [], count: 36, costByDuration: { 4: 36, 8: 72, 12: 108 } },
    { id: 'wan-3-0', vendorId: 'wan', icon: bars, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: wide, resolution: hd }, stops: { duration: [5, 10] }, tags: [], count: 48, costByDuration: { 5: 48, 10: 96 } },
    { id: 'wan-2-7', vendorId: 'wan', icon: bars, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: clip, resolution: ['720p'] }, stops: { duration: [5, 10] }, tags: [], count: 28, costByDuration: { 5: 28, 10: 56 } },
    { id: 'wan-2-6', vendorId: 'wan', icon: bars, workflowIds: videoFlows, fieldIds: ['ratio', 'duration'], options: { ratio: ['16-9'] }, stops: { duration: [5] }, tags: [], count: 14, costByDuration: { 5: 14 } },
    { id: 'grok-imagine', vendorId: 'grok', icon: spark, workflowIds: videoFlows, fieldIds: ['ratio', 'duration'], options: { ratio: clip }, stops: { duration: [6, 10] }, tags: [], count: 30, costByDuration: { 6: 30, 10: 60 } },
    { id: 'kling-3-0', vendorId: 'kling', icon: gem, workflowIds: videoFlows, fieldIds: clipFields, options: { ratio: wide, resolution: hd }, stops: { duration: [5, 10] }, tags: [], count: 45, costByDuration: { 5: 45, 10: 90 } },
    ...
    { id: 'gpt-image-2', vendorId: 'openai', icon: ring, workflowIds: ['text-image', 'image-edit'], fieldIds: ['ratio', 'size', 'format'], options: { ratio: ['auto', '1-1', '16-9', '9-16', '4-3'], size: ['1k', '2k', '4k'], format: ['jpeg', 'png'] }, tags: [{ id: 'free', tone: 'success' }, { id: 'quality', tone: 'crown', icon: crown }], count: 4 },
    { id: 'nano-banana-2', vendorId: 'nano', icon: sun, workflowIds: ['text-image', 'image-edit'], fieldIds: ['ratio', 'size'], options: { ratio: ['1-1', '3-4', '16-9'], size: ['2k', '4k'] }, tags: [], count: 20 },
