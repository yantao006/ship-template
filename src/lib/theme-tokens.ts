...
html[data-mode="auto"],html[data-mode="light"]{${paletteRules(theme.light)}color-scheme:light;}
html[data-mode="dark"],html[data-mode="auto"][data-default-mode="dark"],html[data-mode="auto"]:has([data-default-mode="dark"]){${paletteRules(theme.dark)}color-scheme:dark;}`;
}
